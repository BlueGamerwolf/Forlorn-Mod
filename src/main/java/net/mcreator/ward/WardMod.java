...
import net.mcreator.ward.init.WardModBlockEntities;
...
@Mod("ward")
public class WardMod {
	public static final Logger LOGGER = LogManager.getLogger(WardMod.class);
	public static final String MODID = "ward";

	public WardMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		WardModSounds.REGISTRY.register(bus);
		WardModBlocks.REGISTRY.register(bus);
		WardModBlockEntities.REGISTRY.register(bus);
		WardModItems.REGISTRY.register(bus);
		WardModEntities.REGISTRY.register(bus);

		WardModTabs.REGISTRY.register(bus);
