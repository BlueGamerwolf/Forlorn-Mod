...
public class EnderlinGodEntity extends Monster {
	public EnderlinGodEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WardModEntities.ENDERLIN_GOD.get(), world);
	}

	public EnderlinGodEntity(EntityType<EnderlinGodEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(WardModItems.ENDERLINE_BLADE.get()));
	...
	public static void init() {
		SpawnPlacements.register(WardModEntities.ENDERLIN_GOD.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
