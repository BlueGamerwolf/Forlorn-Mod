...
public class NetherlinGodEntity extends Monster {
	public NetherlinGodEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WardModEntities.NETHERLIN_GOD.get(), world);
	}

	public NetherlinGodEntity(EntityType<NetherlinGodEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(WardModItems.NETHERLINE_BLADE.get()));
	...
	public static void init() {
		SpawnPlacements.register(WardModEntities.NETHERLIN_GOD.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
